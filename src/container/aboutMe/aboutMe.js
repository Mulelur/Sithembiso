...
import img from "../../assets/SithembisoNzima.jpeg";
import { AboutMe } from "../../components";
import { DownloadCVButton } from "../../components/buttons";
import cv from "../../assets/cv/nzima_cv.pdf";
import letter from "../../assets/cv/Sithembiso Nzima_letter.pdf";
    ...
    <AboutMe>
      <AboutMe.Container>
        ...
        <AboutMe.Column>
          ...
          <AboutMe.Heading4>
            Hello! My Name is Sithembiso Nzima.
          </AboutMe.Heading4>
          <AboutMe.Text>
